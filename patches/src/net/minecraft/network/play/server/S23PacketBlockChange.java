...
public class S23PacketBlockChange extends Packet
{
	...
	public NBTTagCompound customTag; //XXX
    ...
    public S23PacketBlockChange(int p_i45177_1_, int p_i45177_2_, int p_i45177_3_, World p_i45177_4_)
    {
		...
		p_i45177_4_.peekTag(p_i45177_1_, p_i45177_2_, p_i45177_3_, this.customTag);
		//XXX
    }
    ...
    public void readPacketData(PacketBuffer p_148837_1_) throws IOException
    {
		...
		if(p_148837_1_.readByte() != 0) this.customTag = p_148837_1_.readNBTTagCompoundFromBuffer();
		//XXX
    }
    ...
    public void writePacketData(PacketBuffer p_148840_1_) throws IOException
    {
		...
		if(this.customTag == null) p_148840_1_.writeByte(0);
		else {
			p_148840_1_.writeByte(1);
			p_148840_1_.writeNBTTagCompoundToBuffer(this.customTag);
		}
		//XXX
    }
